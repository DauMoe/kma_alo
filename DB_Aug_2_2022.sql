...
CREATE TABLE `post_comments`  (
  ...
  `MEDIA_LINK` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `post_reactions`  (
  ...
  `CREATED_AT` timestamp(6) NULL DEFAULT current_timestamp,
  `UPDATED_AT` timestamp(6) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `TYPE` int(10) UNSIGNED NULL DEFAULT 1 COMMENT '1: like, 2: haha',
...
-- ----------------------------
INSERT INTO `post_reactions` VALUES (3, 2, 1, '2022-07-30 20:25:12.662764', '2022-07-30 20:25:19.975638', 3);
...
-- Records of posts
-- ----------------------------
INSERT INTO `posts` VALUES (1, 3, 'SOCIAL MEDIA IS GOOD?', 'If you run this code, you\'ll notice that when you tap \"Go to Details... again\" that it doesn\'t do anything! This is because we are already on the Details route. The navigate function roughly means \"go to this screen\", and if you are already on that screen', '_post_1658591487313.jpg', '2022-07-01 21:50:55', '2022-07-28 00:16:26');
INSERT INTO `posts` VALUES (5, 2, '', '<b>asfa</b>', '_post_1658591487313.jpg', '2022-07-27 22:50:46', '2022-07-28 00:16:24');
INSERT INTO `posts` VALUES (6, 4, '', '<b>asfa</b>', '_post_1658591487313.jpg', '2022-07-27 22:51:27', '2022-07-28 00:16:27');
...
INSERT INTO `relations` VALUES (3, 2, 15, 'FRIEND', '2022-08-02 21:59:10', '2022-08-02 21:59:10');
...
CREATE TABLE `users`  (
  ...
  `ACTIVE_STATUS` int(10) UNSIGNED NULL DEFAULT 0,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (2, 'Ne', 'Gogo', 'daumoe', '0339417291', 'hoangne@gmail.com', '$2b$05$S5W6BHq.5TZ1F8lD3Oazm.LCrl0zUZvR/OYw7E5ADrxMWiCnxNvm.', NULL, 'Nothing about myself', NULL, NULL, 1, 0, NULL, '_avatar_1658763581324.jpg', '', '2022-07-01 21:49:13', '2022-07-25 22:39:41');
INSERT INTO `users` VALUES (3, 'Nguyen', 'Hien', 'ntth', '098214252', 'hhh@gmail.com', '$2b$05$S5W6BHq.5TZ1F8lD3Oazm.LCrl0zUZvR/OYw7E5ADrxMWiCnxNvm.', NULL, NULL, NULL, NULL, 1, 0, NULL, '_avatar_1658763581324.jpg', '', '2022-07-01 21:49:13', '2022-08-02 22:39:20');
INSERT INTO `users` VALUES (4, 'John', 'Nguyen', 'john_nguyen', '0982142524', 'hhh1@gmail.com', '$2b$05$S5W6BHq.5TZ1F8lD3Oazm.LCrl0zUZvR/OYw7E5ADrxMWiCnxNvm.', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL, '', '2022-07-01 21:49:13', '2022-08-02 22:39:22');
INSERT INTO `users` VALUES (15, 'Lee', 'Lee', 'lyly', '033413552', 'ly@gmail.com', '$2b$05$S5W6BHq.5TZ1F8lD3Oazm.LCrl0zUZvR/OYw7E5ADrxMWiCnxNvm.', NULL, NULL, NULL, NULL, 1, 0, NULL, NULL, '', '2022-07-15 23:28:59', '2022-08-02 22:39:23');
