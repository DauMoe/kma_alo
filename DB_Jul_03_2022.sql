...
CREATE TABLE `private_chat`  (
  `EMIT_EVENT_ID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `LISTEN_EVENT_ID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `UID_ONE` int(10) NULL DEFAULT NULL,
  `UID_TWO` int(10) NULL DEFAULT NULL,
  `CREATED_AT` timestamp(0) NOT NULL DEFAULT current_timestamp,
  `UPDATED_AT` datetime(0) NULL DEFAULT current_timestamp ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`EMIT_EVENT_ID`) USING BTREE,
  UNIQUE INDEX `EMIT_EVENT_ID`(`EMIT_EVENT_ID`) USING BTREE,
  UNIQUE INDEX `LISTEN_EVENT_ID`(`LISTEN_EVENT_ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of private_chat
-- ----------------------------
INSERT INTO `private_chat` VALUES ('824d3370-b21d-452c-a476-53eb95b283ec', 'c553e560-fae4-11ec-84ac-215988e5b60c', 2, 3, '2022-07-03 22:28:21', '2022-07-03 22:28:21');
INSERT INTO `private_chat` VALUES ('d4daf871-4065-45ca-9577-5accb6e7b4dc', 'caa3e970-fae4-11ec-84ac-215988e5b60c', 2, 4, '2022-07-03 22:28:30', '2022-07-03 22:28:30');
