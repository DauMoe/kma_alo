...
CREATE TABLE `post_reactions`  (
  `REACT_ID` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `REACT_UID` int UNSIGNED NULL DEFAULT NULL,
  `POST_ID` int UNSIGNED NULL DEFAULT NULL,
  `CREATED_AT` timestamp(6) NULL DEFAULT current_timestamp(6),
  `UPDATED_AT` timestamp(6) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6),
  `TYPE` int UNSIGNED NULL DEFAULT 1 COMMENT '1: like, 2: haha',
...
CREATE TABLE `private_chat`  (
  ...
  `UID_ONE` int UNSIGNED NULL DEFAULT NULL,
  `UID_TWO` int UNSIGNED NULL DEFAULT NULL,
  `CREATED_AT` timestamp(0) NOT NULL DEFAULT current_timestamp(0),
  `UPDATED_AT` datetime(0) NULL DEFAULT current_timestamp(0) ON UPDATE CURRENT_TIMESTAMP(0),
...
CREATE TABLE `users`  (
  ...
  `EMAIL_CONFIRMED` int NOT NULL DEFAULT 0 COMMENT 'active account if email has confirmed',
  `ACTIVE_STATUS` int UNSIGNED NULL DEFAULT 0,
...
INSERT INTO `users` VALUES (3, 'Nguyen', 'Hien', 'ntth', '098214252', 'hhh@gmail.com', '$05$S5W6BHq.5TZ1F8lD3Oazm.LCrl0zUZvR/OYw7E5ADrxMWiCnxNvm.', NULL, NULL, NULL, NULL, 1, 0, NULL, '_avatar_1658763581324.jpg', '', '2022-07-01 21:49:13', '2022-07-25 22:40:31');
